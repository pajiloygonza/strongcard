...
const CatalogSales = () => {
  ...
  const filteredPromotions = promotions.filter((item) => {
    ...
    console.log(
      ...
      }, Скидка: ${discountValue}, minDiscount: ${minDiscount}`
    );
    ...
    <div className="catalog-sales">
      <div className="catalog-sales__container">
        <div className="catalog-sales__filter">
          <div
            className="catalog-sales__filter__back"
          ...
          <div className="catalog-sales__selects">
            <CustomSelect
              label="Акции"
        ...
        <div className="catalog-sales__list">
          ...
          <div className="catalog-sales__list__sorting">
            <CustomSelect
